...
#define msobplekSmartTag		  38
#define msobplekRev				  39
#define msobplekMax               40
...
MSOAPI_(BOOL) MsoFTestCbPv(const void *pv, int cb);
MSOAPI_(BOOL) MsoFTestCbPvRO(const void *pv, int cb);
MSOAPI_(int) MsoCbActualFromPv(const void *pv, int cb);
MSOAPI_(BOOL) MsoFEnsureCbPv(void **ppv, int cb);
MSOAPI_(BOOL) MsoFTestH(void **ppv);
MSOAPI_(BOOL) MsoFTestWz(const WCHAR *wz, int cwchMaxPossible);
MSOAPI_(BOOL) MsoFTestSz(const char *sz, int cchMaxPossible);
MSOAPI_(BOOL) MsoFTestWt(const WCHAR *wt);
MSOAPI_(BOOL) MsoFTestSt(const char *st);
MSOAPI_(BOOL) MsoFTestWtz(const WCHAR *wtz);
MSOAPI_(BOOL) MsoFTestStz(const char *stz);
