...
#undef DEFINE_MSO95_GUID
	...
	#define DEFINE_MSO_GUID(name, bCategory, bIndex) \
		EXTERN_C __declspec(selectany) const GUID name = {0x000C0000 | MAKEWORD(bIndex, bCategory), \
	...
	#define DEFINE_MSO95_GUID(name, bCategory, bIndex) \
		EXTERN_C __declspec(selectany) const GUID name = {0x2DF80000 | MAKEWORD(bIndex, bCategory), \
...
// missing guids (E-Services & WebComponentProperties)
DEFINE_MSO_GUID(IID_IMsoDispAuthentication,     0x03, 0x74);
DEFINE_MSO_GUID(IID_IMsoDispDrmRight,           0x03, 0x75);
DEFINE_MSO_GUID(IID_IMsoDispDrmRights,          0x03, 0x76);
DEFINE_MSO_GUID(IID_IMsoDispSmartDocument,      0x03, 0x77);
DEFINE_MSO_GUID(IID_IMsoDispDWSTask,            0x03, 0x79);
DEFINE_MSO_GUID(IID_IMsoDispDWSTasks,           0x03, 0x7A);
DEFINE_MSO_GUID(IID_IMsoDispDWSFile,            0x03, 0x7B);
DEFINE_MSO_GUID(IID_IMsoDispDWSFiles,           0x03, 0x7C);
DEFINE_MSO_GUID(IID_IMsoDispDWSFolder,          0x03, 0x7D);
DEFINE_MSO_GUID(IID_IMsoDispDWSFolders,         0x03, 0x7E);
DEFINE_MSO_GUID(IID_IMsoDispDWSLink,            0x03, 0x7F);
DEFINE_MSO_GUID(IID_IMsoDispDWSLinks,           0x03, 0x80);
DEFINE_MSO_GUID(IID_IMsoDispDWSMember,          0x03, 0x81);
DEFINE_MSO_GUID(IID_IMsoDispDWSMembers,         0x03, 0x82);
DEFINE_MSO_GUID(IID_IMsoDispExistingWorkspace,  0x03, 0x83);
DEFINE_MSO_GUID(IID_IMsoDispExistingWorkspaces, 0x03, 0x84);
DEFINE_MSO_GUID(IID_IMsoDispWorkspace,          0x03, 0x85);
DEFINE_MSO_GUID(IID_IMsoDispSync,               0x03, 0x86);
DEFINE_MSO_GUID(IID_IMsoDispSTSVersion,         0x03, 0x87);
DEFINE_MSO_GUID(IID_IMsoDispSTSVersions,        0x03, 0x88);
#endif //$[VSMSO]
...
DEFINE_MSO_GUID(IID_IMsoDrmDocument,            0x04, 0x13);
DEFINE_MSO_GUID(IID_IMsoDrmCrypt,               0x04, 0x14);
DEFINE_MSO_GUID(IID_IMsoDrmStorage,             0x04, 0x15);
DEFINE_MSO_GUID(IID_IMsoDrmRightsLabel,         0x04, 0x16);
DEFINE_MSO_GUID(IID_IEnumMsoDrmUserRights,      0x04, 0x17);
DEFINE_MSO_GUID(IID_IMsoDrmUserRights,          0x04, 0x18);
DEFINE_MSO_GUID(IID_IMsoDrmRightsTemplatesManager, 0x04, 0x19);
DEFINE_MSO_GUID(IID_IMsoDrmRightsTemplate,      0x04, 0x1A);
DEFINE_MSO_GUID(IID_IEnumMsoDrmRightsTemplates, 0x04, 0x1B);
DEFINE_MSO_GUID(IID_IMsoDrmUser,                0x04, 0x1C);
DEFINE_MSO_GUID(IID_IMsoDrmUserIdentity,        0x04, 0x1D);
DEFINE_MSO_GUID(IID_IMsoDrmLicenseQueue,        0x04, 0x1E);
...
DEFINE_MSO_GUID(IID_IMsoWDWizard,               0x05, 0x13);
DEFINE_MSO_GUID(IID_IMsoMallocEx,               0x05, 0x14);
DEFINE_MSO_GUID(IID_IMsoFactoidUIHelper,        0x05, 0x15);
DEFINE_MSO_GUID(IID_INuiOleNetPart,             0x05, 0x16);
DEFINE_MSO_GUID(IID_INuiOleNetPartContainer,    0x05, 0x17);
//DEFINE_MSO_GUID(IID_IAsyncSite,                 0x05, 0x18);  // Reserved for NetBar
//DEFINE_MSO_GUID(IID_IAsyncWorker,               0x05, 0x19);  // Currently not in use by Office
DEFINE_MSO_GUID(IID_IMsoSmartDocument,          0x05, 0x1B);
DEFINE_MSO_GUID(IID_IMsoSolutionLibrary,        0x05, 0x1C);
DEFINE_MSO_GUID(IID_IMsoManifest,               0x05, 0x1D);
DEFINE_MSO_GUID(IID_IMsoManifestEventHandler,   0x05, 0x1E);
DEFINE_MSO_GUID(IID_IMsoSmartDocEventHandler,   0x05, 0x1F);
DEFINE_MSO_GUID(IID_IMsolBSTR,                  0x05, 0x20);
DEFINE_MSO_GUID(IID_IMsoSchemaBuggedList,       0x05, 0x21);
...
DEFINE_MSO_GUID(IID_IMsoNuiOcxComponent,        0x06, 0x0D);
...
DEFINE_MSO_GUID(IID_IMsoReducedHTMLImport,          0x09, 0x3A);

DEFINE_MSO_GUID(IID_IMsoSharingWPClient,            0x09, 0x3B);

DEFINE_MSO_GUID(IID_IMsoSchemaInfo,                 0x09, 0x3C);
DEFINE_MSO_GUID(IID_IMsoXmlError,                   0x09, 0x3D);
DEFINE_MSO_GUID(IID_IMsoXFormPaneUser,              0x09, 0x3E);
DEFINE_MSO_GUID(IID_IMsoXFormPaneItem,              0x09, 0x3F);

DEFINE_MSO_GUID(IID_IMsoDwsInfo,                    0x09, 0x40);
DEFINE_MSO_GUID(IID_IMsoDwsCommUser,                0x09, 0x41);
...
// Office11 MSE interfaces
DEFINE_MSO_GUID(IID_IMsoVsPackage11,         0x12, 0x22);   // DANGER: This definition should match msomse.idl and vse.sreg
DEFINE_MSO_GUID(IID_IMsoVsProject11,         0x12, 0x23);   // DANGER: This definition should match msomse.idl and vse.sreg
DEFINE_MSO_GUID(IID_IMsoVsProjectSite11,     0x12, 0x24);   // DANGER: This definition should match msomse.idl and vse.sreg
DEFINE_MSO_GUID(CLSID_MsoVseProxy11,         0x12, 0x25);
DEFINE_MSO_GUID(IID_IMsoVsProjectProxy11,    0x12, 0x26);
DEFINE_MSO_GUID(CLSID_MsoVsMenuPackage11,    0x12, 0x27);
DEFINE_MSO_GUID(IID_IMsoVsSetForegroundWindow11,0x12, 0x28);
DEFINE_MSO_GUID(IID_IMsoVsProjectProxySite11, 0x12, 0x29);
DEFINE_MSO_GUID(CLSID_MsoVsPackageClassObject11,0x12, 0x2A);
...
#define IID_IMsoVsPackage              IID_IMsoVsPackage11
#define IID_IMsoVsProject              IID_IMsoVsProject11
#define IID_IMsoVsProjectSite          IID_IMsoVsProjectSite11
#define CLSID_MsoVseProxy              CLSID_MsoVseProxy11
#define IID_IMsoVsProjectProxy         IID_IMsoVsProjectProxy11
#define CLSID_MsoVsMenuPackage         CLSID_MsoVsMenuPackage11
#define IID_IMsoVsSetForegroundWindow  IID_IMsoVsSetForegroundWindow11
#define IID_IMsoVsProjectProxySite     IID_IMsoVsProjectProxySite11
#define CLSID_MsoVsPackageClassObject  CLSID_MsoVsPackageClassObject11
...
DEFINE_MSO_GUID(IID_IMsoMailMergePubClientSite, 0x15, 0x0E);
//  -- What about 0x0F?
...
// Category 68 is reserved for Inking features (MichKim)
//DEFINE_MSO_GUID(GUID_InkColorSchemeColor,             0x68, 0x00); // stroke property guid - saved
//DEFINE_MSO_GUID(GUID_InkShape,                        0x68, 0x01); // stroke property guid
DEFINE_MSO_GUID(IID_IFakeInkDisp,                     0x68, 0x02);
//DEFINE_MSO_GUID(GUID_InkHighlighterStroke,            0x68, 0x03); // stroke property guid
...
// Category B0 : Office Foundation Services
DEFINE_MSO_GUID(IID_IMsoAuthUser,                  0xB0, 0x00);
DEFINE_MSO_GUID(IID_IMsoAuthMgr,                   0xB0, 0x01);
DEFINE_MSO_GUID(IID_IMsoLoginSession,              0xB0, 0x02);
DEFINE_MSO_GUID(IID_IMsoLoginMaster,               0xB0, 0x03);
DEFINE_MSO_GUID(IID_IMsoKerberosTicket,            0xB0, 0x04);
DEFINE_MSO_GUID(IID_IMsoCredMgr,                   0xB0, 0x05);
DEFINE_MSO_GUID(IID_IMsoCredential,                0xB0, 0x06);
DEFINE_MSO_GUID(IID_IMsoAuthEventCallback,         0xB0, 0x07);
DEFINE_MSO_GUID(IID_IMsoAuthzPermit,               0xB0, 0x08);
DEFINE_MSO_GUID(IID_IMsoAsyncResult,               0xB0, 0x09);
DEFINE_MSO_GUID(IID_IMsoDialupMgr,                 0xB0, 0x0A);

DEFINE_MSO_GUID(IID_IMsoPrivHailstorm,             0xB0, 0x0B);
DEFINE_MSO_GUID(IID_IMsoPrivHailstormEvents,       0xB0, 0x0C);
DEFINE_MSO_GUID(CLSID_OfficePrivate,               0xB0, 0x0D);
DEFINE_MSO_GUID(IID_IMsoNetZone,                   0xB0, 0x0E);
DEFINE_MSO_GUID(IID_IMsoNetStatus,                 0xB0, 0x0F);
DEFINE_MSO_GUID(IID_IMsoNetStatusEventCallback,    0xB0, 0x10);
DEFINE_MSO_GUID(IID_IMsoHSUser,                    0xB0, 0x11);
#endif //$[VSMSO]
...
#if 0 //$[VSMSO]
// Category D2 is used by Office Instant Messenging and Notifications
// GUIDS for IM&N Abstraction Layer - defined in msoimnal.h
DEFINE_MSO_GUID(IID_IMsoIMClientWindow, 0xD2, 0x00);
DEFINE_MSO_GUID(IID_IMsoIMChatWindow, 0xD2, 0x01);
DEFINE_MSO_GUID(IID_IMsoIMNAbstractionLayer, 0xD2, 0x02);
DEFINE_MSO_GUID(LIBID_MsoIMN, 0xD2, 0x06);

// GUIDS for IM&N Objects - defined in msoim.h
DEFINE_MSO_GUID(IID_IMsoIMManager, 0xD2, 0x10);
DEFINE_MSO_GUID(IID_IMsoPersona, 0xD2, 0x11);
DEFINE_MSO_GUID(IID_IMsoPersonaSite, 0xD2, 0x12);
DEFINE_MSO_GUID(IID_IMsoPersonaList, 0xD2, 0x13);
DEFINE_MSO_GUID(IID_IMsoToastInfo, 0xD2, 0x14);
DEFINE_MSO_GUID(IID_IMsoToastAction, 0xD2, 0x15);
DEFINE_MSO_GUID(IID_IMsoIMNALCallback, 0xD2, 0x16);
DEFINE_MSO_GUID(IID_IMsoIMCmpMgr, 0xD2, 0x17);
#endif //$[VSMSO]

// Category D3 is reserved for Data Services
DEFINE_MSO_GUID(IID_IMsoXDMFlattener, 0xD3, 0x00);
DEFINE_MSO_GUID(IID_IMsoXDMTaskpane, 0xD3, 0x01);
DEFINE_MSO_GUID(IID_IMsoXmlInstanceStructureGenerator, 0xD3, 0x02);
DEFINE_MSO_GUID(IID_IMsoXmlInstanceObject, 0xD3, 0x03);
DEFINE_MSO_GUID(IID_IMsoXmlInstanceObjectCollection, 0xD3, 0x04);
DEFINE_MSO_GUID(IID_IMsoXmlClientDataProvider, 0xD3, 0x05);
DEFINE_MSO_GUID(IID_IMsoXmlInstanceBuilder, 0xD3, 0x06);
DEFINE_MSO_GUID(IID_IMsoSAXAttributesCollection, 0xD3, 0x07);
DEFINE_MSO_GUID(IID_IMsoXmlToXSD, 0xD3, 0x08);
DEFINE_MSO_GUID(IID_IMsoXmlInstanceStructure, 0xD3, 0x09);
DEFINE_MSO_GUID(IID_IMsoXMLElementDataTypeSniffer, 0xD3, 0x0A);
DEFINE_MSO_GUID(IID_IMsoXMLAttributeDataTypeSniffer, 0xD3, 0x0B);
DEFINE_MSO_GUID(IID_IMsoXMLDataTypeSnifferClassFactory, 0xD3, 0x0C);
DEFINE_MSO_GUID(IID_IMsoXMLNameSpace, 0xD3, 0x0D);
DEFINE_MSO_GUID(IID_IMsoXDMData, 0xD3, 0x0E);
DEFINE_MSO_GUID(IID_IMsoCSchemaFinderUI, 0xD3, 0x0F);
DEFINE_MSO_GUID(IID_IMsoXDMTaskpaneUser, 0xD3, 0x10);
DEFINE_MSO_GUID(IID_IMsoDSPConnInfo, 0xD3, 0x11);
DEFINE_MSO_GUID(IID_IMsoXmlNamespacePrefixCollection, 0xD3, 0x12);
DEFINE_MSO_GUID(IID_IMsoXmlSchema, 0xD3, 0x13);
DEFINE_MSO_GUID(IID_IMsoSchemaFind, 0xD3, 0x14);
DEFINE_MSO_GUID(IID_IMsoSchemaFindUI, 0xD3, 0x15);
DEFINE_MSO_GUID(IID_IMsoXslSecurityManager, 0xD3, 0x16);

#if 0 //$[VSMSO]
// Category D4 is reserved for Meetings Services
DEFINE_MSO_GUID(IID_IMsoMeetingsService, 0xD4, 0x00);
DEFINE_MSO_GUID(IID_IMeetingsWorkspace, 0xD4, 0x01);
DEFINE_MSO_GUID(IID_IMeetingsWorkspaceUser, 0xD4, 0x02);
DEFINE_MSO_GUID(IID_IMeetServiceClient, 0xD4, 0x03);
DEFINE_MSO_GUID(IID_IMeetServiceClientCallback, 0xD4, 0x04);
