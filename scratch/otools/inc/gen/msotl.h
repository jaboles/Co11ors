...
DEFINE_GUID(IID__MsoIAccessible,0x618736E0L,0x3C3D,0x11CF,0x81,0x0C,0x00,0xAA,0x00,0x38,0x9B,0x71);

/* Definition of interface: _MsoIAccessible */
#undef INTERFACE
#define INTERFACE _MsoIAccessible

DECLARE_INTERFACE_(_MsoIAccessible, IDispatch)
{
BEGIN_INTERFACE
    ...
    STDMETHOD(GetIDsOfNames)(
      THIS_
      REFIID riid,
      _In_count_(cNames) OLECHAR FAR* FAR* rgszNames,
      UINT cNames,
      LCID lcid,
      _Out_cap_(cNames) DISPID FAR* rgdispid) PURE;
...
DEFINE_GUID(IID_SmartDocument,0x000C0377L,0x0000,0x0000,0xC0,0x00,0x00,0x00,0x00,0x00,0x00,0x46);

/* Definition of interface: SmartDocument */
#undef INTERFACE
...
BEGIN_INTERFACE
    ...
    STDMETHOD(get_SolutionID)(THIS_ BSTR FAR* pbstrID) PURE;
    STDMETHOD(put_SolutionID)(THIS_ BSTR bstrID) PURE;
    STDMETHOD(get_SolutionURL)(THIS_ BSTR FAR* pbstrURL) PURE;
    STDMETHOD(put_SolutionURL)(THIS_ BSTR bstrURL) PURE;
    STDMETHOD(PickSolution)(THIS_ VARIANT_BOOL ConsiderAllSchemas) PURE;
    STDMETHOD(RefreshPane)(THIS) PURE;
};

DEFINE_GUID(IID_SharedWorkspaceMember,0x000C0381L,0x0000,0x0000,0xC0,0x00,0x00,0x00,0x00,0x00,0x00,0x46);

/* Definition of interface: SharedWorkspaceMember */
#undef INTERFACE
...
BEGIN_INTERFACE
    ...
    STDMETHOD(get_DomainName)(THIS_ BSTR FAR* pbstrDomainName) PURE;
    STDMETHOD(get_Name)(THIS_ BSTR FAR* pbstrName) PURE;
    STDMETHOD(get_Email)(THIS_ BSTR FAR* pbstrEmail) PURE;
    STDMETHOD(Delete)(THIS) PURE;
    STDMETHOD(get_ID)(THIS_ BSTR FAR* ID) PURE;
    STDMETHOD(get_Parent)(THIS_ IDispatch * FAR* ppidisp) PURE;
};

DEFINE_GUID(IID_SharedWorkspaceMembers,0x000C0382L,0x0000,0x0000,0xC0,0x00,0x00,0x00,0x00,0x00,0x00,0x46);

/* Definition of interface: SharedWorkspaceMembers */
#undef INTERFACE
...
BEGIN_INTERFACE
    ...
    STDMETHOD(get__NewEnum)(THIS_ IUnknown * FAR* ppienum) PURE;
    STDMETHOD(get_Item)(THIS_ int Index, SharedWorkspaceMember FAR* FAR* ppidisp) PURE;
    STDMETHOD(get_Count)(THIS_ int FAR* pcItems) PURE;
    STDMETHOD(Add)(THIS_ BSTR Email, BSTR DomainName, BSTR DisplayName, VARIANT Role, SharedWorkspaceMember FAR* FAR* ppMember) PURE;
    STDMETHOD(get_Parent)(THIS_ IDispatch * FAR* ppidisp) PURE;
    STDMETHOD(get_ItemCountExceeded)(THIS_ VARIANT_BOOL FAR* pf) PURE;
};
...
DEFINE_GUID(IID_SharedWorkspaceTask,0x000C0379L,0x0000,0x0000,0xC0,0x00,0x00,0x00,0x00,0x00,0x00,0x46);

/* Definition of interface: SharedWorkspaceTask */
#undef INTERFACE
...
BEGIN_INTERFACE
    ...
    STDMETHOD(get_Title)(THIS_ BSTR FAR* Title) PURE;
    STDMETHOD(put_Title)(THIS_ BSTR Title) PURE;
    STDMETHOD(get_AssignedTo)(THIS_ BSTR FAR* AssignedTo) PURE;
    STDMETHOD(put_AssignedTo)(THIS_ BSTR AssignedTo) PURE;
    STDMETHOD(get_Status)(THIS_ MsoSharedWorkspaceTaskStatus FAR* Status) PURE;
    STDMETHOD(put_Status)(THIS_ MsoSharedWorkspaceTaskStatus Status) PURE;
    STDMETHOD(get_Priority)(THIS_ MsoSharedWorkspaceTaskPriority FAR* Priority) PURE;
    STDMETHOD(put_Priority)(THIS_ MsoSharedWorkspaceTaskPriority Priority) PURE;
    STDMETHOD(get_Description)(THIS_ BSTR FAR* Description) PURE;
    STDMETHOD(put_Description)(THIS_ BSTR Description) PURE;
    STDMETHOD(get_DueDate)(THIS_ VARIANT FAR* DueDate) PURE;
    STDMETHOD(put_DueDate)(THIS_ VARIANT DueDate) PURE;
    STDMETHOD(get_CreatedBy)(THIS_ BSTR FAR* CreatedBy) PURE;
    STDMETHOD(get_CreatedDate)(THIS_ VARIANT FAR* CreatedDate) PURE;
    STDMETHOD(get_ModifiedBy)(THIS_ BSTR FAR* ModifiedBy) PURE;
    STDMETHOD(get_ModifiedDate)(THIS_ VARIANT FAR* ModifiedDate) PURE;
    STDMETHOD(Save)(THIS) PURE;
    STDMETHOD(Delete)(THIS) PURE;
    STDMETHOD(get_Parent)(THIS_ IDispatch * FAR* ppidisp) PURE;
};

DEFINE_GUID(IID_SharedWorkspaceTasks,0x000C037AL,0x0000,0x0000,0xC0,0x00,0x00,0x00,0x00,0x00,0x00,0x46);

/* Definition of interface: SharedWorkspaceTasks */
#undef INTERFACE
...
BEGIN_INTERFACE
    ...
    STDMETHOD(get_Item)(THIS_ int Index, SharedWorkspaceTask FAR* FAR* ppidisp) PURE;
    STDMETHOD(get_Count)(THIS_ int FAR* pcItems) PURE;
    STDMETHOD(Add)(THIS_ BSTR Title, VARIANT Status, VARIANT Priority, VARIANT Assignee, VARIANT Description, VARIANT DueDate, SharedWorkspaceTask FAR* FAR* ppTask) PURE;
    STDMETHOD(get_Parent)(THIS_ IDispatch * FAR* ppidisp) PURE;
    STDMETHOD(get_ItemCountExceeded)(THIS_ VARIANT_BOOL FAR* pf) PURE;
    STDMETHOD(get__NewEnum)(THIS_ IUnknown * FAR* ppienum) PURE;
};

DEFINE_GUID(IID_SharedWorkspaceFile,0x000C037BL,0x0000,0x0000,0xC0,0x00,0x00,0x00,0x00,0x00,0x00,0x46);

/* Definition of interface: SharedWorkspaceFile */
#undef INTERFACE
...
BEGIN_INTERFACE
    ...
    STDMETHOD(get_URL)(THIS_ BSTR FAR* pbstrFileName) PURE;
    STDMETHOD(get_CreatedBy)(THIS_ BSTR FAR* pbstrCreatedBy) PURE;
    STDMETHOD(get_CreatedDate)(THIS_ VARIANT FAR* CreatedDate) PURE;
    STDMETHOD(get_ModifiedBy)(THIS_ BSTR FAR* pbstrModifiedBy) PURE;
    STDMETHOD(get_ModifiedDate)(THIS_ VARIANT FAR* ModifiedDate) PURE;
    STDMETHOD(Delete)(THIS) PURE;
    STDMETHOD(get_Parent)(THIS_ IDispatch * FAR* ppidisp) PURE;
};

DEFINE_GUID(IID_SharedWorkspaceFiles,0x000C037CL,0x0000,0x0000,0xC0,0x00,0x00,0x00,0x00,0x00,0x00,0x46);

/* Definition of interface: SharedWorkspaceFiles */
#undef INTERFACE
...
BEGIN_INTERFACE
    ...
    STDMETHOD(get__NewEnum)(THIS_ IUnknown * FAR* ppienum) PURE;
    STDMETHOD(get_Item)(THIS_ int Index, SharedWorkspaceFile FAR* FAR* ppidisp) PURE;
    STDMETHOD(get_Count)(THIS_ int FAR* pcItems) PURE;
    STDMETHOD(Add)(THIS_ BSTR Filename, VARIANT ParentFolder, VARIANT OverwriteIfFileAlreadyExists, VARIANT KeepInSync, SharedWorkspaceFile FAR* FAR* ppFile) PURE;
    STDMETHOD(get_Parent)(THIS_ IDispatch * FAR* ppidisp) PURE;
    STDMETHOD(get_ItemCountExceeded)(THIS_ VARIANT_BOOL FAR* pf) PURE;
};

DEFINE_GUID(IID_SharedWorkspaceFolder,0x000C037DL,0x0000,0x0000,0xC0,0x00,0x00,0x00,0x00,0x00,0x00,0x46);

/* Definition of interface: SharedWorkspaceFolder */
#undef INTERFACE
...
BEGIN_INTERFACE
    ...
    STDMETHOD(get_FolderName)(THIS_ BSTR FAR* FolderName) PURE;
    STDMETHOD(Delete)(THIS_ VARIANT DeleteEventIfFolderContainsFiles) PURE;
    STDMETHOD(get_Parent)(THIS_ IDispatch * FAR* ppidisp) PURE;
};

DEFINE_GUID(IID_SharedWorkspaceFolders,0x000C037EL,0x0000,0x0000,0xC0,0x00,0x00,0x00,0x00,0x00,0x00,0x46);

/* Definition of interface: SharedWorkspaceFolders */
#undef INTERFACE
...
BEGIN_INTERFACE
    ...
    STDMETHOD(get__NewEnum)(THIS_ IUnknown * FAR* ppienum) PURE;
    STDMETHOD(get_Item)(THIS_ int Index, SharedWorkspaceFolder FAR* FAR* ppidisp) PURE;
    STDMETHOD(get_Count)(THIS_ int FAR* pcItems) PURE;
    STDMETHOD(Add)(THIS_ BSTR FolderName, VARIANT ParentFolder, SharedWorkspaceFolder FAR* FAR* ppFolder) PURE;
    STDMETHOD(get_Parent)(THIS_ IDispatch * FAR* ppidisp) PURE;
    STDMETHOD(get_ItemCountExceeded)(THIS_ VARIANT_BOOL FAR* pf) PURE;
};

DEFINE_GUID(IID_SharedWorkspaceLink,0x000C037FL,0x0000,0x0000,0xC0,0x00,0x00,0x00,0x00,0x00,0x00,0x46);

/* Definition of interface: SharedWorkspaceLink */
#undef INTERFACE
...
BEGIN_INTERFACE
    ...
    STDMETHOD(get_URL)(THIS_ BSTR FAR* URL) PURE;
    STDMETHOD(put_URL)(THIS_ BSTR URL) PURE;
    STDMETHOD(get_Description)(THIS_ BSTR FAR* Description) PURE;
    STDMETHOD(put_Description)(THIS_ BSTR Description) PURE;
    STDMETHOD(get_Notes)(THIS_ BSTR FAR* Notes) PURE;
    STDMETHOD(put_Notes)(THIS_ BSTR Notes) PURE;
    STDMETHOD(get_CreatedBy)(THIS_ BSTR FAR* CreatedBy) PURE;
    STDMETHOD(get_CreatedDate)(THIS_ VARIANT FAR* CreatedDate) PURE;
    STDMETHOD(get_ModifiedBy)(THIS_ BSTR FAR* ModifiedBy) PURE;
    STDMETHOD(get_ModifiedDate)(THIS_ VARIANT FAR* ModifiedDate) PURE;
...
DEFINE_GUID(IID_SharedWorkspaceLinks,0x000C0380L,0x0000,0x0000,0xC0,0x00,0x00,0x00,0x00,0x00,0x00,0x46);

/* Definition of interface: SharedWorkspaceLinks */
#undef INTERFACE
...
BEGIN_INTERFACE
    ...
    STDMETHOD(get__NewEnum)(THIS_ IUnknown * FAR* ppienum) PURE;
    STDMETHOD(get_Item)(THIS_ int Index, SharedWorkspaceLink FAR* FAR* ppidisp) PURE;
    STDMETHOD(get_Count)(THIS_ int FAR* pcItems) PURE;
    STDMETHOD(Add)(THIS_ BSTR URL, VARIANT Description, VARIANT Notes, SharedWorkspaceLink FAR* FAR* ppLink) PURE;
    STDMETHOD(get_Parent)(THIS_ IDispatch * FAR* ppidisp) PURE;
    STDMETHOD(get_ItemCountExceeded)(THIS_ VARIANT_BOOL FAR* pf) PURE;
};

DEFINE_GUID(IID_SharedWorkspace,0x000C0385L,0x0000,0x0000,0xC0,0x00,0x00,0x00,0x00,0x00,0x00,0x46);

/* Definition of interface: SharedWorkspace */
#undef INTERFACE
...
BEGIN_INTERFACE
    ...
    STDMETHOD(get_Name)(THIS_ BSTR FAR* Name) PURE;
    STDMETHOD(put_Name)(THIS_ BSTR Name) PURE;
    STDMETHOD(get_Members)(THIS_ SharedWorkspaceMembers FAR* FAR* ppMembers) PURE;
    STDMETHOD(get_Tasks)(THIS_ SharedWorkspaceTasks FAR* FAR* ppTasks) PURE;
    STDMETHOD(get_Files)(THIS_ SharedWorkspaceFiles FAR* FAR* ppFiles) PURE;
    STDMETHOD(get_Folders)(THIS_ SharedWorkspaceFolders FAR* FAR* ppFolders) PURE;
    STDMETHOD(get_Links)(THIS_ SharedWorkspaceLinks FAR* FAR* ppLinks) PURE;
    STDMETHOD(Refresh)(THIS) PURE;
    STDMETHOD(CreateNew)(THIS_ VARIANT URL, VARIANT Name) PURE;
    STDMETHOD(Delete)(THIS) PURE;
    STDMETHOD(get_Parent)(THIS_ IDispatch * FAR* ppidisp) PURE;
    STDMETHOD(get_URL)(THIS_ BSTR FAR* pbstrURL) PURE;
    STDMETHOD(get_Connected)(THIS_ VARIANT_BOOL FAR* pfConnected) PURE;
    STDMETHOD(get_LastRefreshed)(THIS_ VARIANT FAR* pvarLastRefreshed) PURE;
    STDMETHOD(get_SourceURL)(THIS_ BSTR FAR* pbstrSourceURL) PURE;
    STDMETHOD(put_SourceURL)(THIS_ BSTR SourceURL) PURE;
    STDMETHOD(RemoveDocument)(THIS) PURE;
...
DEFINE_GUID(IID_Sync,0x000C0386L,0x0000,0x0000,0xC0,0x00,0x00,0x00,0x00,0x00,0x00,0x46);

/* Definition of interface: Sync */
#undef INTERFACE
...
BEGIN_INTERFACE
    ...
    /* Sync methods */
    STDMETHOD(get_Status)(THIS_ MsoSyncStatusType FAR* pStatusType) PURE;
    STDMETHOD(get_WorkspaceLastChangedBy)(THIS_ BSTR FAR* pbstrWorkspaceLastChangedBy) PURE;
    STDMETHOD(get_LastSyncTime)(THIS_ VARIANT FAR* pdatSavedTo) PURE;
    STDMETHOD(get_ErrorType)(THIS_ MsoSyncErrorType FAR* pErrorType) PURE;
    STDMETHOD(GetUpdate)(THIS) PURE;
    STDMETHOD(PutUpdate)(THIS) PURE;
    STDMETHOD(OpenVersion)(THIS_ MsoSyncVersionType SyncVersionType) PURE;
    STDMETHOD(ResolveConflict)(THIS_ MsoSyncConflictResolutionType SyncConflictResolution) PURE;
    STDMETHOD(Unsuspend)(THIS) PURE;
    STDMETHOD(get_Parent)(THIS_ IDispatch * FAR* ppidisp) PURE;
};

DEFINE_GUID(IID_DocumentLibraryVersion,0x000C0387L,0x0000,0x0000,0xC0,0x00,0x00,0x00,0x00,0x00,0x00,0x46);

/* Definition of interface: DocumentLibraryVersion */
#undef INTERFACE
...
BEGIN_INTERFACE
    ...
    STDMETHOD(get_Modified)(THIS_ VARIANT FAR* pvarDate) PURE;
    STDMETHOD(get_Index)(THIS_ long FAR* lIndex) PURE;
    STDMETHOD(get_Parent)(THIS_ IDispatch * FAR* ppidisp) PURE;
    STDMETHOD(get_ModifiedBy)(THIS_ BSTR FAR* userName) PURE;
    STDMETHOD(get_Comments)(THIS_ BSTR FAR* comments) PURE;
    STDMETHOD(Delete)(THIS) PURE;
    STDMETHOD(Open)(THIS_ IDispatch * FAR* ppdispOpened) PURE;
    STDMETHOD(Restore)(THIS_ IDispatch * FAR* ppdispOpened) PURE;
};

DEFINE_GUID(IID_DocumentLibraryVersions,0x000C0388L,0x0000,0x0000,0xC0,0x00,0x00,0x00,0x00,0x00,0x00,0x46);

/* Definition of interface: DocumentLibraryVersions */
#undef INTERFACE
...
BEGIN_INTERFACE
    ...
    STDMETHOD(get_Item)(THIS_ long lIndex, DocumentLibraryVersion FAR* FAR* ppidisp) PURE;
    STDMETHOD(get_Count)(THIS_ long FAR* lCount) PURE;
    STDMETHOD(get_Parent)(THIS_ IDispatch * FAR* ppidisp) PURE;
    STDMETHOD(get_IsVersioningEnabled)(THIS_ VARIANT_BOOL FAR* pvarfVersioningOn) PURE;
    STDMETHOD(get__NewEnum)(THIS_ IUnknown * FAR* ppienum) PURE;
};
...
DEFINE_GUID(IID_UserPermission,0x000C0375L,0x0000,0x0000,0xC0,0x00,0x00,0x00,0x00,0x00,0x00,0x46);

/* Definition of interface: UserPermission */
#undef INTERFACE
...
BEGIN_INTERFACE
    ...
    STDMETHOD(get_UserId)(THIS_ BSTR FAR* UserId) PURE;
    STDMETHOD(get_Permission)(THIS_ long FAR* Permission) PURE;
    STDMETHOD(put_Permission)(THIS_ long Permission) PURE;
    STDMETHOD(get_ExpirationDate)(THIS_ VARIANT FAR* ExpirationDate) PURE;
    STDMETHOD(put_ExpirationDate)(THIS_ VARIANT ExpirationDate) PURE;
    STDMETHOD(get_Parent)(THIS_ IDispatch * FAR* ppidisp) PURE;
    STDMETHOD(Remove)(THIS) PURE;
};

DEFINE_GUID(IID_Permission,0x000C0376L,0x0000,0x0000,0xC0,0x00,0x00,0x00,0x00,0x00,0x00,0x46);

/* Definition of interface: Permission */
#undef INTERFACE
...
BEGIN_INTERFACE
    ...
    /* Permission methods */
    STDMETHOD(get_Item)(THIS_ VARIANT Index, UserPermission FAR* FAR* UserPerm) PURE;
    STDMETHOD(get_Count)(THIS_ long FAR* Count) PURE;
    STDMETHOD(get_EnableTrustedBrowser)(THIS_ VARIANT_BOOL FAR* Enable) PURE;
    STDMETHOD(put_EnableTrustedBrowser)(THIS_ VARIANT_BOOL Enable) PURE;
    STDMETHOD(Add)(THIS_ BSTR UserId, VARIANT Permission, VARIANT ExpirationDate, UserPermission FAR* FAR* UserPerm) PURE;
    STDMETHOD(ApplyPolicy)(THIS_ BSTR FileName) PURE;
    STDMETHOD(get_Parent)(THIS_ IDispatch * FAR* ppidisp) PURE;
    STDMETHOD(RemoveAll)(THIS) PURE;
    STDMETHOD(get_Enabled)(THIS_ VARIANT_BOOL FAR* Enabled) PURE;
    STDMETHOD(put_Enabled)(THIS_ VARIANT_BOOL Enabled) PURE;
    STDMETHOD(get_RequestPermissionURL)(THIS_ BSTR FAR* Contact) PURE;
    STDMETHOD(put_RequestPermissionURL)(THIS_ BSTR Contact) PURE;
    STDMETHOD(get_PolicyName)(THIS_ BSTR FAR* PolicyName) PURE;
    STDMETHOD(get_PolicyDescription)(THIS_ BSTR FAR* PolicyDescription) PURE;
    STDMETHOD(get_StoreLicenses)(THIS_ VARIANT_BOOL FAR* Enabled) PURE;
    STDMETHOD(put_StoreLicenses)(THIS_ VARIANT_BOOL Enabled) PURE;
    STDMETHOD(get_DocumentAuthor)(THIS_ BSTR FAR* Author) PURE;
    STDMETHOD(put_DocumentAuthor)(THIS_ BSTR Author) PURE;
    STDMETHOD(get_PermissionFromPolicy)(THIS_ VARIANT_BOOL FAR* FromPolicy) PURE;
    STDMETHOD(get__NewEnum)(THIS_ IUnknown * FAR* ppunkEnum) PURE;
};
...
#else //$[VSMSO]
#pragma once
#include "vsmso.h" // Generated from vsmso.idl in vscommon\idl

// Translation to old IMsoDisp names. Caution: Not all of these have leading underscores!
#define IID_IMsoDispCommandBar __uuidof(CommandBar)
#define IID_IMsoDispCommandBarControl __uuidof(CommandBarControl)
#define IID_IMsoDispCommandBarControls __uuidof(CommandBarControls)
#define IID_IMsoDispCommandBarComboBox __uuidof(_CommandBarComboBox)
#define IID_IMsoDispCommandBars __uuidof(_CommandBars)
#define IID_IMsoDispCommandBarButton __uuidof(_CommandBarButton)
#define IID_IMsoDispCommandBarActiveX __uuidof(_CommandBarActiveX)
#define IID_IMsoDispCommandBarPopup __uuidof(CommandBarPopup)
#define DIID_IMsoDispCommandBarsEvents __uuidof(_CommandBarsEvents)
#define DIID_IMsoDispCommandBarButtonEvents __uuidof(_CommandBarButtonEvents)
#define DIID_IMsoDispCommandBarComboBoxEvents __uuidof(_CommandBarComboBoxEvents)
